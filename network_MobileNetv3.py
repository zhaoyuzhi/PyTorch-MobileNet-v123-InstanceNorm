...
def conv_bn(inp, oup, stride, conv_layer=nn.Conv2d, norm_layer=nn.InstanceNorm2d, nlin_layer=nn.ReLU):
...
def conv_1x1_bn(inp, oup, conv_layer=nn.Conv2d, norm_layer=nn.InstanceNorm2d, nlin_layer=nn.ReLU):
    return nn.Sequential(
...
if __name__ == "__main__":
    ...
    net = MobileNetV3_small(last_channels = 1280, n_class = 1000, dropout = 0)
