...
if __name__ == "__main__":
    ...
    parser.add_argument('--finetune_path', type = str, \
        default = './models/vgg/vgg16/rgb/vgg16_in_fc_rgb_epoch150_bs256.pth', \
    ...
    parser.add_argument('--sub_type', type = str, default = 'vgg16_in_fc', help = 'sub network types of vgg | resnet')
